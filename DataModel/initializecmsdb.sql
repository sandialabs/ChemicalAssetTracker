...
VALUES ('20200630163057_01InitialMigration', '2.1.4-rtm-31024');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20200710234403_02Hazards', '2.1.4-rtm-31024');

ALTER TABLE `ChemicalsOfConcern` CHANGE `INECP` `WMD` bit NOT NULL DEFAULT FALSE;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20211106180117_03WMD', '2.1.4-rtm-31024');
